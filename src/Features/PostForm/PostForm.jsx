  ...
  const onSavePost = () => {
    if (title && content) {
      ...
      if (spaceIndex !== -1) {
        ...
        if (useInitials) {
          processedName = `${processedName.slice(0, 1).toUpperCase()} ${processedName.slice(1, 2).toUpperCase()}`;
        } else {
  ...
  return (
    ...
    >
      <div className="form-wrapper bg-white rounded-xl w-11/12 px-4 md:px-8 lg:px-14 py-2 md:py-4 lg:py-8">
        ...
        <form style={{ minHeight: "480px" }} className="flex justify-between md:gap-2 items-center">
          {/* RIGHT SIDE */}
          <div className="left md:w-1/2 w-full py-6">
            <p className="font-semibold text-sm md:text-xl pb-3">Name</p>
            <input
            ...
            <p className="font-semibold text-sm md:text-xl pb-3">Location</p>
            <input
              placeholder="Paris"
              value={location}
            ...
            <p className="font-semibold text-sm md:text-xl pb-3">Gender:</p>
            <select
              value={gender}
          ...
          <div className="right md:w-1/2 hidden md:inline-block">
            <img className="w-full justify-end items-center" src={tweet2} alt="" />
          </div>
        </form>
      </div>
    </div>
